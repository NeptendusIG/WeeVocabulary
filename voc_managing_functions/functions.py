...
# PERSONAL MODULES
import voc_managing_functions.anki_maker as anki_maker
...
def establish_files():
    ...
    FICHIERS """
    File.create_file_tree(main_settings_json, settings_dict)
    ...
    File.create_file_tree("data/output/en_waitlist.json")
    File.create_file_tree("data/output/fr_waitlist.json")
    File.create_file_tree("data/backup/en_saves.json")
    File.create_file_tree("data/output/fr_saves.json")
    ...
    os.makedirs("data/output/fr_anki", exist_ok=True)
    os.makedirs("data/output/en_anki", exist_ok=True)
