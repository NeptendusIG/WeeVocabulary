...
# NOTES :
"""Les 3 Applications :
- NewWordsListApp : Montre les mots en attente
- ReadyWordsApp : Afficher les mots prêts à être traités (vers Anki)
- ShowDataFrame : Afficher la grille des mots et leurs informations
"""
# IMPORTS
import os, sys
